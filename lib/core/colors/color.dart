...
class FleetrideColors {

  FleetrideColors._();
   static const Color deepBlue = Color(0xFF003366); // Primary background
  static const Color deepBlueAccent = Color(0xFF004C99); // Button or accent
...
static const Color buttonColor = Color(0xFF003366);
  static const Color blackColor = Color.fromARGB(233, 9, 9, 9);
  ...
  static const Color yellow2 = Color(0xffFFD015);
