...
class AuthenticationApi {
  ...
  AuthenticationApi({required AuthenticationFacade authenticationFacade})
  ...
  AccountSummaryDetails? get selectedAccountSummary {
    final index = _customerAccountInfo.accountSummaryDetails.indexWhere(
      (element) => element.accountNumber == _customerAccountInfo.accountNumber,
    );
  ...
  void updateEmail(String email) {
    ...
    _customerAccountInfoNotifier.value = _customerAccountInfoNotifier.value
        .copyWith(
          selectedCustomerDetails: _customerAccountInfoNotifier
              .value
              .selectedCustomerDetails!
              .copyWith(emailAddress: email),
        );
  }
    ...
    _customerAccountInfoNotifier.value = _customerAccountInfoNotifier.value
        .copyWith(
          selectedCustomerDetails: _customerAccountInfoNotifier
              .value
              .selectedCustomerDetails!
              .copyWith(mobileNumber: phoneNumber),
        );
  }
}
